...
Thanks for helping map paid Microsoft security capabilities to real
configuration.
...
Follow [Adding a check](adding-a-check.md).
...
Be respectful. See [CODE_OF_CONDUCT.md](https://github.com/d4rk-pri0r/licenselens/blob/main/CODE_OF_CONDUCT.md).
