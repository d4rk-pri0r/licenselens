...
from licenselens.catalog._reference_coverage import (
    load_coverage_rows,
    load_excluded_items,
    load_untracked_rows,
)
...
def build_reference_model(paths: ReferenceModelPaths | None = None) -> ReferenceModel:
    ...
    excluded_items, excluded_errors = load_excluded_items(source_paths.coverage_path)
    ...
    return ReferenceModel(
        ...
        excluded_items=tuple(sorted(excluded_items, key=lambda row: row.item)),
    )
...
def _reference_check(
    ...
    return ReferenceCheck(
        ...
        flagship=check.flagship,
        flagship_security_intent=check.flagship_security_intent,
