...
from licenselens.collectors.runtime_collect_endpoint import (
    ...
    collect_mdi_health_runtime,
    collect_pbi_capacity_runtime,
    collect_purview_dlp_runtime,
    collect_purview_ediscovery_runtime,
...
_COLLECTORS: dict[str, EvidenceCollectorFn] = {
    ...
    "mdi_health": collect_mdi_health_runtime,
    ...
    "license_assignment": collect_license_assignment_runtime,
    ...
    "purview_insider_risk": collect_purview_insider_risk_runtime,
    "pbi_capacity_bundle": collect_pbi_capacity_runtime,
    "security_defaults_policy": collect_security_defaults_runtime,
    "access_review_definitions": collect_access_reviews_runtime,
    "access_review_instances": collect_access_review_instances_runtime,
    "access_packages": collect_access_packages_runtime,
    "risky_service_principals": collect_risky_service_principals_runtime,
